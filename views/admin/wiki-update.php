                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form action="updateWiki" method="POST" id="updateWikiForm" enctype="multipart/form-data">
                                                <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                                                <input type="hidden" name="wiki_id" value="<?php echo $wikiDetails->getId(); ?>"> <!-- Include wiki ID for update -->

                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Article Title</label>
                                                    <input type="text" id="title" class="form-control" name="title" placeholder="Enter Article Title" value="<?php echo $wikiDetails->getTitle(); ?>">
                                                    <span id="titleError" class="error"></span>
                                                </div>

                                                <div class="mb-3">
                                                    <textarea id="content" class="form-control" name="content" placeholder="Enter Article Content"><?php echo $wikiDetails->getContent(); ?></textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="category" name="category">
                                                        ...
                                                        <?php foreach ($categories as $category) : ?>
                                                            <?php if ($category->getId() === $wikiDetails->getCategoryId()) : ?>
                                                                <option value="<?php echo $category->getId(); ?>" selected><?php echo $category->getCategoryName(); ?></option>
                                                            <?php else : ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select multiple class="form-select" id="tags" name="tags[]" size="5">
                                                        <?php
                                                        // Assuming $selectedTags is an array of tag names associated with the wiki
                                                        $selectedTags = $wikiDetails->getTags(); // Fetch selected tags from your Wiki object
                                                        foreach ($tags as $tag) : ?>
                                                            <option value="<?php echo $tag->getId(); ?>" <?php echo (in_array($tag->getTagName(), $selectedTags)) ? 'selected' : ''; ?>>
                                                ...
                                                <div class="mb-3">
                                                    <label for="article_image" class="form-label">Uploaded Article Image</label>
                                                </div>
                                                <div class="mb-3">
                                                    <img src="/wiki/app/routes/<?php echo $wikiDetails->getImage(); ?>" alt="Article Image" class="img-fluid">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <button type="submit" id="updateArticleButton" class="btn btn-primary" name="updateWiki">Update Wiki</button>
                                            </form>
