        ...
        <div class="container">
          <div class="row blog-entries element-animate">
            <div class="col-md-12 col-lg-8 main-content">
              <img src="/wiki/app/routes/../../public/images/img_10.jpg" alt="Image" class="img-fluid mb-5" />
              <div class="post-meta">
                <span class="author mr-2"
                  ><img src="/wiki/app/routes/../../public/images/person_1.jpg" alt="Colorlib" class="mr-2" />
                  Colorlib</span
                >&bullet; <span class="mr-2">March 15, 2018 </span> &bullet;
              ...
              <div class="post-content-body">
                ...
                <div class="row mb-5">
                  <div class="col-md-12 mb-4">
                    <img
                      src="/wiki/app/routes/../../public/images/img_7.jpg"
                  ...
                  <div class="col-md-6 mb-4">
                    <img
                      src="/wiki/app/routes/../../public/images/img_9.jpg"
                      alt="Image placeholder"
                      class="img-fluid"
                    />
                  </div>
                  <div class="col-md-6 mb-4">
                    <img
                      src="/wiki/app/routes/../../public/images/img_11.jpg"
                      alt="Image placeholder"
                      class="img-fluid"
                    />
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
              <a
                href="#"
                class="a-block sm d-flex align-items-center height-md"
                style="background-image: url('/wiki/app/routes/../../public/images/img_4.jpg')"
              >
                <div class="text">
                  <div class="post-meta">
