...
<?php include 'includes/nav.php';?>
  <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('/wiki/app/routes/../../public/images/hero_5.jpg');">
    <div class="container">
        ...
        <div class="col-md-6">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 me-3 d-inline-block"><img src="/wiki/app/routes/../../public/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
          ...
          <div class="post-content-body">
            ...
            <div class="row my-4">
              <div class="col-md-12 mb-4">
                <img src="/wiki/app/routes/../../public/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="/wiki/app/routes/../../public/images/img_2_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="/wiki/app/routes/../../public/images/img_3_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
            </div>
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="sidebar-box">
            <div class="bio text-center">
              <img src="/wiki/app/routes/../../public/images/person_2.jpg" alt="Image Placeholder" class="img-fluid mb-3">
              <div class="bio-body">
          ...
          <div class="sidebar-box">
            ...
            <div class="post-entry-sidebar">
              <ul>
                <li>
                  <a href="">
                    <img src="/wiki/app/routes/../../public/images/img_1_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                    <div class="text">
                ...
                <li>
                  <a href="">
                    <img src="/wiki/app/routes/../../public/images/img_2_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                    <div class="text">
                      <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                      <div class="post-meta">
                        <span class="mr-2">March 15, 2018 </span>
                ...
                <li>
                  <a href="">
                    <img src="/wiki/app/routes/../../public/images/img_3_sq.jpg" alt="Image placeholder" class="me-4 rounded">
                    <div class="text">
                      <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                      <div class="post-meta">
                        <span class="mr-2">March 15, 2018 </span>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="blog-entry">
            <a href="single.html" class="img-link">
              <img src="/wiki/app/routes/../../public/images/img_1_horizontal.jpg" alt="Image" class="img-fluid">
            </a>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="blog-entry">
            <a href="single.html" class="img-link">
              <img src="/wiki/app/routes/../../public/images/img_2_horizontal.jpg" alt="Image" class="img-fluid">
            </a>
            <span class="date">Apr. 14th, 2022</span>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="blog-entry">
            <a href="single.html" class="img-link">
              <img src="/wiki/app/routes/../../public/images/img_3_horizontal.jpg" alt="Image" class="img-fluid">
            </a>
            <span class="date">Apr. 14th, 2022</span>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="blog-entry">
            <a href="single.html" class="img-link">
              <img src="/wiki/app/routes/../../public/images/img_4_horizontal.jpg" alt="Image" class="img-fluid">
            </a>
            <span class="date">Apr. 14th, 2022</span>
